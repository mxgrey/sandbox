...
public:
  ...
  {
    std::cout << "hit spot 0a" << std::endl;
    if (other._has_value)
    {
      if (_has_value)
      {
        std::cout << "hit spot 1a" << std::endl;
        _storage._value = other._storage._value;
      }
      else
      {
        std::cout << "hit spot 2a" << std::endl;
        new (&_storage._value) T(other._storage._value);
      }
    }
    else if (_has_value)
    {
  ...
  {
    std::cout << "hit spot 0b" << std::endl;
    if (other._has_value)
    {
      if (_has_value)
      {
        std::cout << "hit spot 1b" << std::endl;
        _storage._value = std::move(other._storage._value);
      }
      else
      {
        std::cout << "hit spot 2b" << std::endl;
...
optional<TestStruct> get_struct()
{
  return TestStruct{1, 2.0};
}

int main()
{
  optional<TestStruct> uninitialized;
  uninitialized = get_struct();
}
